 ...
 */
public class HistoryBookActivity extends drawer1 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRef = mDatabase.child("Student").child(RollNo).child("HistoryBookList").getRef();
        ...
        mRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                {
                    Toast.makeText(HistoryBookActivity.this,"No Books",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(HistoryBookActivity.this,viewbook.class);
    ...
    {
        mAdapter = new HistoryBookAdapter(k);
    ...
    class ChildAddAsync extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            pd = new ProgressDialog(HistoryBookActivity.this);
